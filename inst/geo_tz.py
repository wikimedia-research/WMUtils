...
#Set up argparse
parser = argparse.ArgumentParser(description="tzdata-code geolocation")
...
for entry in ip_list:
  ...
  if(re.search(":",entry)):
    ...
    try:
      output.append(str(ip6_geo.time_zone_by_addr(entry)+"\n"))
    except:
  ...
  #4, use 4.
    ...
    try:
      output.append(str(ip4_geo.time_zone_by_addr(entry)+"\n"))
    except:
      output.append("Invalid\n")
