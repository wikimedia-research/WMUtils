...
log_sieve <- function(log_data){
  ...
  log_data <- log_data[grepl(x = log_data$URL, pattern = "((commons|meta|species)\\.((m|zero)\\.)?wikimedia\\.)|(wik(tionary|isource|ibooks|ivoyage|iversity|iquote|inews|ipedia|ilog_data)\\.)",
